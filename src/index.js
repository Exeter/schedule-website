...
(function() {
  var BUSINESS_DURATION, BUSINESS_END, BUSINESS_START, Calendar, DAY, calendar, dayNames, monthNames;
  ...
  Calendar = (function() {
    ...
    Calendar.prototype.render = function(begin) {
      ...
      return this.data(begin, begin + DAY * 7, (function(_this) {
  ...
  calendar = new Calendar($('#calendar').css('height', '100%'), function(start, end, cb) {
    return $.ajax({
      url: '/events',
      data: {
        from: start,
